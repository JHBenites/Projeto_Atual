class OrbitaTerrestre:
    def __init__(self, vagas, numero_de_orbitas, mobilidade_extraveicular): #mobilidade aqui
    ...
    def __str__(self):
        return 'Número de vagas contratadas: ' + self.vagas + \
            ' - Número de Órbitas: ' + str(self.numero_de_orbitas) + self.__to_str_mobilidade_extraveicular__()
